...
---
# Nov 12 log
- been able to run Point-SAM demo
- done converting .txt format to .ply
- example header:
```
ply
format ascii 1.0
element vertex 10887794
property float x
property float y
property float z
property uchar red
...
37,0,0,131,131,131
```
- TODO: figure out the error generated by running the Point-SAM demo
