...
def main(args):
    ...
    for time_Myr in range(args.start_time, args. end_time):
        ...
        _, new_dens, _ = get_velz_dens(obj, x_range_scaled, y_range_scaled, z_range_scaled)
        ...
        for current_z in range(args.upper_bound - args.lower_bound):
            dens_slice = normalize4thresholding(new_dens[:, :, current_z + args.lower_bound]) 
        ...
        if(DEBUG):
            print(f"Done processing time: {time_Myr}. .ply stored at: {args.ply_root}/{time_Myr}.ply")
...
if __name__ == "__main__":
    ...
    # python hdf52ply.py -st 209 -et 210 --ply_root /home/joy0921/Desktop/Dataset/img_pix256/plys