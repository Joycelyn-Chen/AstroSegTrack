...
def save2txt(args, timestamp, mask_arr, img_arr, inst_label_arr):
    ply_root = ensure_dir(args.ply_root)
    
    output_file = os.path.join(ply_root, f'{timestamp}.ply')  
        
    with open(output_file, 'w') as f:
        header = '''ply
format ascii 1.0
element vertex 56079
property float x
property float y
property float z
property uchar red
...
if __name__ == "__main__":
    ...
    parser.add_argument("--ply_root", help="Path to output root", default = ".")
...
# python jpg2ply.py --mask_root /UBC-O/joy0921/Desktop/Dataset/MHD-3DIS/masks --img_root /UBC-O/joy0921/Desktop/Dataset/MHD-3DIS/img --ply_root /UBC-O/joy0921/Desktop/Dataset/MHD-3DIS/plys -st 209 -et 210 
