...
def main(args):
    ...
    for timestamp in range(args.start_timestamp, args.end_timestamp, args.interval):
        ...
        for SN_num in range(len(filtered_data)):
            ...
            SN_start_timestamp = time_Myr2timestamp(filtered_data.iloc[SN_num]["time_Myr"])       
            ...
            # pull all imgs 
            for slice_timestamp in range(SN_start_timestamp, SN_start_timestamp + 100, args.interval):        # 100 timestamp = 10 Myr
...
if __name__ == "__main__":
    ...
    # python observe_SN_blast.py --start_timestamp 200 --end_timestamp 201 --interval 1 --delta_t 0.1 --dataset_root "../../Dataset" --dat_file_root "SNfeedback" --output_root "../../Dataset/Explosions" --hdf5_root /home/joy0921/Desktop/Dataset/200_360/finer_time_200_360_original
